...
import com.vk.id26639136.sweater.domain.Role;
import com.vk.id26639136.sweater.domain.User;
import com.vk.id26639136.sweater.repos.UserRepo;
...
public class UserServiceTest {
    ...
    public void userFailTest() {
        ...
        Mockito.verify(userRepo, Mockito.times(0)).save(Mockito.any(User.class));
